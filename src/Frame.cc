...
Frame::Frame(const Frame &frame)
    :mpORBvocabulary(frame.mpORBvocabulary), mpORBextractorLeft(frame.mpORBextractorLeft), mpORBextractorRight(frame.mpORBextractorRight),
     ...
     mvpMapPoints(frame.mvpMapPoints), mvpMapPoints_middle(frame.mvpMapPoints_middle), mvpMapPoints_high(frame.mvpMapPoints_high), 
     mvbOutlier(frame.mvbOutlier), mvbOutlier_middle(frame.mvbOutlier_middle), mvbOutlier_high(frame.mvbOutlier_high),
     mnId(frame.mnId),
...
void Frame::ExtractORBWAF(int flag, const cv::Mat &im, const cv::Mat &im_middle, const cv::Mat &im_high)
{
    if(flag==0){
        (*mpORBextractorLeft)(im,cv::Mat(),mvKeys,mDescriptors);
